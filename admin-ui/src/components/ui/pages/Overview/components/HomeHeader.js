      ...
      <div className="flex items-center gap-3 p-0 mt-1">
        <div className="flex flex-col justify-center">
          ...
          <div className="text-gray-400 text-[14px] font-medium leading-none mt-2 ml-[1px]">
            Overview of your review program
          </div>
        </div>
      </div>

      <div className="flex items-center gap-3">
        <button className="p-2 text-gray-400 hover:text-orange-500 transition-colors rounded-full focus:outline-none focus:ring-0">
          <span className="sr-only">Help</span>
          <HelpCircle className="w-5 h-5" strokeWidth={1.5} />
        </button>

        <button className="p-2 text-gray-400 hover:text-orange-500 transition-colors relative rounded-full focus:outline-none focus:ring-0">
