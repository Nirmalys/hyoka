...
class Apps extends Base
{
    ...
    private static function getProviderConfigs(): array
    {
        return [
            'csv' => [
                'label'                       => __('CSV / Excel spreadsheet', 'hyoka-product-reviews'),
                'default_product_match'       => 'product_id',
                'finalize_match_type'         => 'product_id',
                'external_app'                => '',
                'uses_finalize_provider'      => false,
                'uses_curated_status'         => false,
                'upload_help'                 => __('Upload a CSV export or save your Excel sheet as CSV. Use our template if you are building a file from scratch.', 'hyoka-product-reviews'),
                'product_match_hint'          => '',
                'recommended_product_columns' => ['product_id', 'product_handle', 'product_sku'],
            ],
            'judgeme' => [
                'label'                       => __('Judge.me', 'hyoka-product-reviews'),
                ...
                'upload_help'                 => __('In Judge.me: Manage Reviews → Import & Export → Export published reviews. Upload that CSV here.', 'hyoka-product-reviews'),
                'product_match_hint'          => __('Judge.me exports usually include product_handle (WooCommerce slug) or product_id. Handle matching works best for most stores.', 'hyoka-product-reviews'),
                'recommended_product_columns' => ['product_handle', 'product_id', 'product_sku'],
            ],
            'yotpo' => [
                'label'                       => __('Yotpo', 'hyoka-product-reviews'),
                'default_product_match'       => 'product_sku',
                'finalize_match_type'         => 'product_sku',
                'external_app'                => 'Yotpo',
                'uses_finalize_provider'      => true,
                'uses_curated_status'         => false,
                'upload_help'                 => __('In Yotpo: Reviews → Export reviews (CSV). Upload the export file here — we map Yotpo column names automatically.', 'hyoka-product-reviews'),
                'product_match_hint'          => __('Yotpo exports often include Product SKU or Product ID. SKU matching is recommended for WooCommerce stores.', 'hyoka-product-reviews'),
    ...
    public static function getProvidersForAdmin(): array
    {
        $providers = [
            [
                'id'          => 'judgeme',
                'label'       => __('Judge.me', 'hyoka-product-reviews'),
                'description' => __('Import reviews exported from Judge.me (CSV). Map columns and match products by ID, SKU, or handle.', 'hyoka-product-reviews'),
                'status'      => 'active',
                'import_type' => 'file',
                'accent'      => 'violet',
                'icon'        => 'judgeme',
            ...
            [
                'id'          => 'yotpo',
                'label'       => __('Yotpo', 'hyoka-product-reviews'),
                'description' => __('Import reviews exported from Yotpo (CSV). Supports Yotpo column names and product matching.', 'hyoka-product-reviews'),
                'status'      => 'active',
                'import_type' => 'file',
                'accent'      => 'blue',
                'icon'        => 'yotpo',
            ...
            [
                'id'          => 'csv',
                'label'       => __('CSV / Excel', 'hyoka-product-reviews'),
                'description' => __('Generic spreadsheet import for any review export or custom template.', 'hyoka-product-reviews'),
                'status'      => 'active',
                'import_type' => 'file',
                'accent'      => 'orange',
                'icon'        => 'spreadsheet',
