...
class Setup
{
    ...
    public static function uninstall()
    {
        ...
        if ($delete_data) {
            ...
            $wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}hka_reviews");
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.DirectDatabaseQuery.SchemaChange, WordPress.DB.PreparedSQL.InterpolatedNotPrepared, PluginCheck.Security.DirectDB.SchemaChange
            $wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}hka_customer");
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.DirectDatabaseQuery.SchemaChange, WordPress.DB.PreparedSQL.InterpolatedNotPrepared, PluginCheck.Security.DirectDB.SchemaChange
            $wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}hka_import");
